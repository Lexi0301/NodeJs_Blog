<template>
  <div class="main-content">
    <!-- 列表页 -->
    <div v-if="showFlag && this.flag === 'yonghu'">
      ...
      <div class="table-content">
        <el-table class="tables" size="medium" show-header="true"
            ...
            <el-table-column sortable="true" align="center"   prop="picture"
                header-align="center"
                width="200"
                label="收藏图片">
                <template slot-scope="scope">
            ...
            <el-table-column width="300" align="center"  
               header-align="center"
                label="操作">
                <template slot-scope="scope">
                <el-button type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info',scope.row.refid)">详情</el-button>
...
export default {
  ...
  methods: {
    ...
    // 添加/修改
    addOrUpdateHandler(id,type,refid) {
      this.showFlag = false;
      ...
      this.$nextTick(() => {
        this.$refs.addOrUpdate.init(id,type,refid);
      });
    },
    // 删除
    deleteHandler(id) {
